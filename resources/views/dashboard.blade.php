        ...
        <div class="container-fluid py-4">
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-uppercase font-weight-bold">عدد المنشورات والمحتوى
                                        </p>
                                        <h5 class="font-weight-bolder">
                                            {{ $products_count }}
                                        </h5>
            ...
            <div class="row mt-4">
                <div class="col-lg-7 mb-lg-0 mb-4">
                    <div class="card z-index-2 h-100">
                        ...
                        <div class="card-body p-3">
                            <div class="chart">
                                <canvas id="userChart" class="chart-canvas" height="300"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="carousel-inner border-radius-lg h-100">
                                @foreach ($advertisements as $a)
                                    <div class="carousel-item h-100 active"
                                        style="background-image: url('{{ asset('http://alphaword.sy/storage/' . $a->image) }}');
            ...
            <div class="row mt-4">
                <div class="col-lg-5">
                    <div class="card">
                        <div class="card-header pb-0 p-3">
                            <h6 class="mb-0">أكثر الحافظات نشاطاً</h6>
                        </div>
                        <div class="card-body p-3">
                            <ul class="list-group">
                                @foreach ($topAddresses as $item)
                                    <li
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="text-xs">{{ $item->user_countad }}</span>
                                            </div>
                                        </div>
                                    </li>
                                @endforeach
                ...
                <div class="col-lg-5">
                    <div class="card">
                        <div class="card-header pb-0 p-3">
                            <h6 class="mb-0">أكثر الصفحات تمت متابعتها</h6>
                        </div>
                        <div class="card-body p-3">
                            <ul class="list-group">
                ...
                new Chart(document.getElementById('userChart'), {
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'عدد المستخدمين الجدد لكل شهر'
                            }
                        }
                    }
                });
